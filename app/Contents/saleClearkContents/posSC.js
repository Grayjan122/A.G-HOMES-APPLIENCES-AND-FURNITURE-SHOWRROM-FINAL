            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  border: 'none',
                  background: saleMode === 'inventory' ? '#7c3aed' : 'white',
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  border: 'none',
                  background: saleMode === 'custom' ? '#7c3aed' : 'white',
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginBottom: '12px' }}>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '8px',
                        border: 'none',
                        background: paymentPlan === 'installment' 
                          ? '#d1d5db' 
                          : (customerType === 'walk-in' ? '#7c3aed' : '#f3f4f6'),
                        color: paymentPlan === 'installment' 
                          ? '#9ca3af' 
                          : (customerType === 'walk-in' ? 'white' : 'black'),
