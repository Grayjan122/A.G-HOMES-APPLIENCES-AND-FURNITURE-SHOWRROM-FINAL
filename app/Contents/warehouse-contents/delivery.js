                        ...
                        currentItems1.map((p, i) => (
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    right: 0,
                                    height: '4px',
                                    background: p.delivery_status === "Delivered"
                                ...
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        fontSize: '12px',
                                        fontWeight: '600',
                                        backgroundColor: p.delivery_status === "Delivered"
                                            ? '#d4edda'
                                            : '#fff3cd',
                                        color: p.delivery_status === "Delivered"
                                            ? '#155724'
                                            : '#856404',
                                        border: `2px solid ${p.delivery_status === "Delivered" ? '#28a745' : '#ffc107'}`
                                    }}>
                                        {p.delivery_status}
                                    </div>
                                </div>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            ...
                                            <div style={{
                                                ...
                                                {`${p.fname || ''} ${p.mname || ''} ${p.lname || ''}`.trim() || 'Not Assigned'}
                                            </div>
                                        </div>
                                    </div>
                                </div>
